...
function PopupContinue()
{
   ...
   var Title = "Avaya Enterprise Audit Tool Ver 6.6                                       - Jason Evoy";
...
function MakeFile()
   ...
   os.write("¦Avaya Enterprise Audit Tool v6.6 Results - ");
   os.write(new Date());
   os.write(cr);
...
function PopupError()
  {
    var Title = "ERROR: This is a modified version of Neat6.6.js & has been removed for your safety";
    var shell = WScript.CreateObject("WScript.Shell");
