...
function PopupContinue()
{
   ...
   var Title = "Avaya Enterprise Audit Tool Ver 5.0                       - Jason Evoy";
...
function GetCompInfo()
{
   ...
   for (; !enumItems.atEnd(); enumItems.moveNext())
	...
	// TotalMessage +="Daylight Savings Time Checked: \t" + objItem.EnableDaylightSavingsTime + cr;
