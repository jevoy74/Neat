...
function Sleep()
{
   var sec = 300000; for (i=0 ; i < sec ;  i++) {var wait=i}
}

function PopupContinue()
{
   var InfoIcon = 64; var OkButton = 0; var Timeout = 15;
   var Title = "Avaya Enterprise Audit Tool Ver 6.3                                       - Jason Evoy";
...
function PopupError()
  {
    var Title = "ERROR: This is a modified version of Neat6.3.js & has been removed for your safety";
    var shell = WScript.CreateObject("WScript.Shell");
