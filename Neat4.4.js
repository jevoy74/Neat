 ...
 *    Min Req:    Windows 2000, 2003, XP, 2008 Internet Explorer 5.5 or higher
 ************************************************************************************************/
var TotalMessage = "";
NetStat();
NetRoute();
...
function PopupContinue()
{
   ...
   var Title = "Avaya Enterprise Audit Tool Ver 4.4                       - Jason Evoy";
...
function MakeFile()
   ...
   os.write("¦Avaya Enterprise Audit Tool Results - ");
   os.write(Date());
   os.write(cr);
   ...
   os.Write(GetCCMS7PEPS());
   os.Write(GetCCMA7PEPS());
   os.Write(GetCCMSUPEPS());
   os.Write(GetCCLM7PEPS());
   os.Write(GetSCEPEPS());
   os.Write(GetCCCCPEPS());
...
function GetCC7Info()
{
	...
	var shell = new ActiveXObject( "WScript.Shell" );
       	var regkey2 = "HKLM\\Software\\Nortel\\Setup\\SerialNumber";
  	var regkey3 = "HKLM\\Software\\Nortel\\Setup\\Platform Version";
	var regkey4 = "HKLM\\Software\\Nortel\\Setup\\Revision";
  	var regkey5 = "HKLM\\Software\\Nortel\\Setup\\UserCompany";
	var regkey6 = "HKLM\\Software\\Nortel\\Setup\\UserName";
	var regkey8 = "HKLM\\Software\\Nortel\\Setup\\CCMSHostname";
	var regkey9 = "HKLM\\Software\\Nortel\\Setup\\CCTHostname";
	TotalMessage += "Version: ";
	TotalMessage += (shell.RegRead( regkey3 ) );
	TotalMessage += " Build: ";
	TotalMessage += (shell.RegRead( regkey4 ) + cr );
	TotalMessage += "CCMS Hostname: ";
	TotalMessage += (shell.RegRead( regkey8 ) + cr );
...
function GetCCMS7PEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\CCMS"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "CCMS" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetCCMA7PEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\CCMA"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "CCMA" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetCCLM7PEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\LM"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "CCLM" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetCCMSUPEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\SU"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "CCMSU" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetCCCCPEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\CommonComponents"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "CCCC" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetCCT7PEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\CCT"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "CCT" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetSCEPEPS()
{
	...
	RegistryPath = "SOFTWARE\\Nortel\\Contact Center\\Product Updates\\SCE_Server"
	...
	for (x = 0; x <= aNames.length -1; x++)
	{
	   var KeyName = aNames[x]
	   GetPatchKey (KeyName); 
	   TotalMessage += "SCE_S" + TAB + KeyName + cr;
   	} 
	}
	catch( e )
    {
...
function GetJava()
{
   try
   {
   var FILENAME = "C:\\Java.log";
   var JavaDIR = "\"C:\\Program Files\\Java\" ";
   var Wshell = new ActiveXObject("WScript.Shell");
   var command = "cmd.exe /c dir /a ";
   command += JavaDIR;
   command += ">" + FILENAME;
   Wshell.run (command, 0, true);
   var DIR = "";
   var cr = "\r\n";
   var TotalMessage = "Java Version: \t";
   var shell = new ActiveXObject( "WScript.Shell" );
   var regkey1 = "HKLM\\Software\\JreMetrics\\JreVersion";
   TotalMessage += (shell.RegRead( regkey1 ) + cr );
   var forReading = 1, forWriting = 2, forAppending = 8;
...
function GetJava2008()
{
   try
   {
   var TotalMessage = "Java Version: \t";
   var FILENAME = "C:\\Java.log";
   var JavaDIR = "C:\\Progra~2\\Java\\ ";
   var shell = new ActiveXObject("WScript.Shell");
   var command = "cmd.exe /c dir /a ";
   command += JavaDIR;
   command += ">" + FILENAME;
   ...
   var DIR = "";
   var cr = "\r\n";
   var regkey1 = "HKLM\\Software\\Wow6432Node\\JavaSoft\\Java Update\\Policy\\InstalledJreVersion";
   TotalMessage += (shell.RegRead( regkey1 ) + cr);
   var forReading = 1, forWriting = 2, forAppending = 8;
   shell = new ActiveXObject("Scripting.FileSystemObject");
   var os = shell.GetFile(FILENAME);
