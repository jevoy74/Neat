 ...
 *                Designed for Nortel Enterprise Products, but will work on any PC running W2K or W2K3
...
function PopupContinue()
{
   ...
   var OkButton	       = 0;
   var Timeout         = 4;
   var Title = "Nortel Enterprise Audit Tool Ver 3.3                       - Jason Evoy";
...
function GetChasis()
{
    ...
    for (;!ichasis.atEnd();ichasis.moveNext())
   {
        ...
        TotalMessage += "Manufacturer: " + CHAS.Manufacturer + cr;	
...
while ((EventCounter != 25) && (!enumItems.atEnd()))
   {
...
try
{
   ...
   var objWMIService = GetObject("winmgmts:\\\\.\\root\\CIMV2") ;
   var colItems = objWMIService.ExecQuery("SELECT * FROM Win32_NTLogEvent where LogFile='System'", "WQL",
                                          wbemFlagReturnImmediately | wbemFlagForwardOnly) ;
